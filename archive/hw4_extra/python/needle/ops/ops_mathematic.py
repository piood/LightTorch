...
from ..backend_ndarray.ndarray import cpu

# NOTE: we will import numpy as the array_api
# as the backend for our computations, this line will change in later homeworks

from ..backend_selection import array_api, BACKEND , NDArray
...
class Conv(TensorOp):
    ...
    def compute(self, A, B):
        ...
        img2col = A.as_strided(shape=(N, out_H, out_W, K, K, C_in),
                            strides=(Ns, Hs*self.stride, Ws*self.stride, Hs, Ws, Cs)) \
                                .compact()\
                                .reshape((N*out_H*out_W, inner_dim))
        out = img2col @ B.compact().reshape((K*K*C_in, C_out))
