...
__global__ void CompactKernel(const scalar_t* a, scalar_t* out, size_t size, CudaVec shape,
   ...
   */
  size_t gid = blockIdx.x * blockDim.x + threadIdx.x;
  if(gid < size) out[gid] = a[gid_to_idx(gid, shape, strides, offset)];
  /// BEGIN SOLUTION
  /// END SOLUTION
}
...
__global__ void EwiseSetitemKernel(const scalar_t* a, scalar_t* out, size_t size, CudaVec shape,
                                   CudaVec strides, size_t offset) {
  /**
   * Set items in a (compact) array using CUDA.  This is the kernel that will do the actual work.
   * 
   * Args:
...
void EwiseDiv(const CudaArray& a, const CudaArray& b, CudaArray* out) {
  /**
   * Divide together two CUDA array
   */
  CudaDims dim = CudaOneDim(out->size);
...
void ScalarDiv(const CudaArray& a, scalar_t val, CudaArray* out) {
  /**
   * Divide together a CUDA array and a scalar value.
   */
  CudaDims dim = CudaOneDim(out->size);
...
void ScalarPower(const CudaArray& a, scalar_t val, CudaArray* out) {
  /**
   * Raise a CUDA array to a scalar power
   */
  CudaDims dim = CudaOneDim(out->size);
...
void EwiseMaximum(const CudaArray& a, const CudaArray& b, CudaArray* out) {
  /**
   * Take the elementwise maximum of two CUDA arrays
   */
  CudaDims dim = CudaOneDim(out->size);
...
void ScalarMaximum(const CudaArray& a, scalar_t val, CudaArray* out) {
  /**
   * Take the elementwise maximum of a CUDA array and a scalar value
   */
  CudaDims dim = CudaOneDim(out->size);
...
void EwiseEq(const CudaArray& a, const CudaArray& b, CudaArray* out) {
  /**
   * Take the elementwise equality of two CUDA arrays
   */
  CudaDims dim = CudaOneDim(out->size);
...
void ScalarEq(const CudaArray& a, scalar_t val, CudaArray* out) {
  /**
   * Take the elementwise equality of a CUDA array and a scalar value
   */
  CudaDims dim = CudaOneDim(out->size);
...
void EwiseGe(const CudaArray& a, const CudaArray& b, CudaArray* out) {
  /**
   * Take the elementwise greater than or equal to of two CUDA arrays
   */
  CudaDims dim = CudaOneDim(out->size);
...
void ScalarGe(const CudaArray& a, scalar_t val, CudaArray* out) {
  /**
   * Take the elementwise greater than or equal to of a CUDA array and a scalar value
   */
  CudaDims dim = CudaOneDim(out->size);
...
void EwiseLog(const CudaArray& a, CudaArray* out) {
  /**
   * Take the elementwise log of a CUDA array
   */
  CudaDims dim = CudaOneDim(out->size);
...
void EwiseExp(const CudaArray& a, CudaArray* out) {
  /**
   * Take the elementwise exp of a CUDA array
   */
  CudaDims dim = CudaOneDim(out->size);
...
void EwiseTanh(const CudaArray& a, CudaArray* out) {
  /**
   * Take the elementwise tanh of a CUDA array
   */
  CudaDims dim = CudaOneDim(out->size);
