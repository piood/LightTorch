...
void EwiseDiv(const AlignedArray& a, const AlignedArray& b, AlignedArray* out) {
  /**
   * Set entries in out to be the division of corresponding entries in a by b.
   */
  for (size_t i = 0; i < a.size; i++) {
    out->ptr[i] = a.ptr[i] / b.ptr[i];
  }
...
void ScalarPower(const AlignedArray& a, scalar_t val, AlignedArray* out) {
  /**
   * Set entries in out to be the power of corresponding entry in a by the scalar val.
   */
  for (size_t i = 0; i < a.size; i++) {
...
void EwiseEq(const AlignedArray& a, const AlignedArray& b, AlignedArray* out) {
  /**
   * Set entries in out to be 1 if corresponding entries in a and b are equal, 0 otherwise.
   */
  for (size_t i = 0; i < a.size; i++) {
...
void ScalarEq(const AlignedArray& a, scalar_t val, AlignedArray* out) {
  /**
   * Set entries in out to be 1 if corresponding entry in a is equal to the scalar val, 0 otherwise.
   */
  for (size_t i = 0; i < a.size; i++) {
...
void EwiseGe(const AlignedArray& a, const AlignedArray& b, AlignedArray* out) {
  /**
   * Set entries in out to be 1 if corresponding entries in a are greater than or equal to b, 0
   * otherwise.
   */
  for (size_t i = 0; i < a.size; i++) {
    out->ptr[i] = a.ptr[i] >= b.ptr[i] ? 1 : 0;
...
void ScalarGe(const AlignedArray& a, scalar_t val, AlignedArray* out) {
  /**
   * Set entries in out to be 1 if corresponding entry in a is greater than or equal to the scalar
   * val, 0 otherwise.
   */
  for (size_t i = 0; i < a.size; i++) {
    out->ptr[i] = a.ptr[i] >= val ? 1 : 0;
