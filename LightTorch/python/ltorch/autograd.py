...
class TensorTuple(Value):
    ...
    def __getitem__(self, index: int):
        return ltorch.ops.tuple_get_item(self, index)
    ...
    def __add__(self, other):
        ...
        return ltorch.ops.make_tuple(*[self[i] + other[i] for i in range(len(self))])
...
class Tensor(Value):
    ...
    def __add__(self, other):
        if isinstance(other, Tensor):
            return ltorch.ops.EWiseAdd()(self, other)
        else:
            return ltorch.ops.AddScalar(other)(self)

    def __mul__(self, other):
        if isinstance(other, Tensor):
            return ltorch.ops.EWiseMul()(self, other)
        else:
            return ltorch.ops.MulScalar(other)(self)
    ...
    def __pow__(self, other):
        ...
        if isinstance(other, Tensor):
            ...
            return ltorch.ops.PowerScalar(other)(self)
        ### END YOUR SOLUTION

    def __sub__(self, other):
        if isinstance(other, Tensor):
            return ltorch.ops.EWiseAdd()(self, ltorch.ops.Negate()(other))
        else:
            return ltorch.ops.AddScalar(-other)(self)
       
    def __rsub__(self, other):
        if isinstance(other, Tensor):
            return ltorch.ops.EWiseAdd()(ltorch.ops.Negate()(self), other)
        else:
            return ltorch.ops.AddScalar(other)(-self)

    def __truediv__(self, other):
        if isinstance(other, Tensor):
            return ltorch.ops.EWiseDiv()(self, other)
        else:
            return ltorch.ops.DivScalar(other)(self)

    def __matmul__(self, other):
        return ltorch.ops.MatMul()(self, other)

    def matmul(self, other):
        return ltorch.ops.MatMul()(self, other)

    def sum(self, axes=None):
        return ltorch.ops.Summation(axes)(self)

    def broadcast_to(self, shape):
        return ltorch.ops.BroadcastTo(shape)(self)

    def reshape(self, shape):
        return ltorch.ops.Reshape(shape)(self)

    def __neg__(self):
        return ltorch.ops.Negate()(self)

    def transpose(self, axes=None):
        return ltorch.ops.Transpose(axes)(self)
